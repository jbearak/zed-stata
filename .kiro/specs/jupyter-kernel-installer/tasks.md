...
- [ ] 1. Create installer script skeleton with output helpers
  - [ ] 1.1 Create `install-jupyter-stata.sh` with shebang, header comments, and `set -euo pipefail`
    - Include usage documentation in header
    - Define configuration constants (VENV_DIR, CONFIG_FILE, GITHUB_RAW_BASE, GITHUB_REF)
    - _Requirements: 6.1, 6.3_
  - [ ] 1.2 Implement output helper functions
...
- [ ] 2. Implement prerequisite checks
  - [ ] 2.1 Implement `check_macos()` function
    - Verify `uname` returns "Darwin"
    - Exit with error if not macOS
    - _Requirements: 7.1_
  - [ ] 2.2 Implement `check_python3()` function
    ...
    - _Requirements: 7.2_
  - [ ] 2.3 Implement `check_prerequisites()` that calls both checks
    - _Requirements: 7.5_

- [ ] 3. Implement Stata detection
  - [ ] 3.1 Implement `detect_stata_app()` function
  ...
  - [ ] 3.2 Implement execution mode determination
  ...
  - [ ] 3.3 Write property test for edition-to-mode mapping
...
- [ ] 4. Implement virtual environment management
  - [ ] 4.1 Implement `create_venv()` function
  ...
  - [ ] 4.2 Implement `install_packages()` function
...
- [ ] 5. Implement configuration management
  - [ ] 5.1 Implement `get_config_template()` function
    ...
    - _Requirements: 4.1_
  - [ ] 5.2 Implement `write_config()` function
  ...
  - [ ] 5.3 Write property test for config preservation
    - **Property 6: Config File Preserves User Customizations**
    - **Validates: Requirements 4.4**

- [ ] 6. Implement kernel registration
  - [ ] 6.1 Implement `register_kernel()` function
    - Run `$VENV_DIR/bin/python -m stata_kernel.install`
    - Handle registration errors
    - _Requirements: 5.1_
  - [ ] 6.2 Implement `verify_kernel_spec()` function
...
- [ ] 7. Implement uninstallation
  - [ ] 7.1 Implement `uninstall()` function
...
- [ ] 8. Implement main function and installation summary
  - [ ] 8.1 Implement `main()` function
...
- [ ] 10. Update README.md documentation
  - [ ] 10.1 Add "Jupyter REPL (Optional)" section after "Send to Stata"
  ...
  - [ ] 10.2 Add "Jupyter Kernel" subsection to "Building from Source"
