...
- [ ] 1. Add --include flag to send-to-stata.sh
  - [ ] 1.1 Add INCLUDE_MODE variable and parse --include flag in argument parsing
    - Add `INCLUDE_MODE=false` to global variables
    - Add case for `--include)` in parse_arguments() that sets INCLUDE_MODE=true
    - _Requirements: 1.1, 1.2, 1.3_
  - [ ] 1.2 Modify send_to_stata() to use include or do based on flag
  ...
  - [ ] 1.3 Update print_usage() to document --include flag
    - Add `--include` to Options section in help text
    - _Requirements: 1.4_

- [ ] 2. Update installer with new tasks and keybindings
  - [ ] 2.1 Add Include Statement and Include File tasks to STATA_TASKS
  ...
  - [ ] 2.2 Add alt-cmd-enter and alt-shift-cmd-enter keybindings
  ...
  - [ ] 2.3 Update print_summary() to show all four keybindings
    - Add include keybindings to the summary output
    - _Requirements: 3.1, 3.2_

- [ ] 3. Checkpoint - Verify script and installer changes
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Update documentation
  - [ ] 4.1 Update SEND-TO-STATA.md with all four keybindings and do vs include explanation
  ...
  - [ ] 4.2 Update README.md to mention send-to-stata feature
    - Add brief mention of send-to-stata with link to SEND-TO-STATA.md
    - _Requirements: 4.3_
  - [ ] 4.3 Add keybinding reference to AGENTS.md
