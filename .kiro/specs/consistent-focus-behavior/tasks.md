...
- [x] 1. Update Windows executable for new default behavior
  - [x] 1.1 Modify SendToStata.cs to return focus to Zed by default
  ...
  - [x] 1.2 Write unit tests for Windows argument parsing
...
- [x] 4. Update macOS installer for focus behavior
  - [x] 4.1 Add focus behavior prompt to install-send-to-stata.sh
  ...
  - [x] 4.2 Update task generation in install-send-to-stata.sh
  ...
  - [x] 4.3 Write unit tests for macOS installer task generation
